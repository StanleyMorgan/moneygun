...
// FIX: Converted this file to a global script by removing `export {}` and the `declare global` wrapper.
// This ensures TypeScript recognizes custom JSX elements across the project without module augmentation issues.
