...
// FIX: Wrap global augmentations in `declare global` to fix the "Top-level declarations..." error.
// This is necessary when a file is treated as a module but needs to modify the global namespace.
declare global {
