            ...
            <div className="pt-4 border-t border-slate-100">
                <div className="flex justify-between items-center min-h-[36px]">
                    ...
                    <div className="flex-shrink-0 flex justify-end items-center gap-2">
                        {airdrop.action && airdrop.action.url && (
                            <a 
                                href={airdrop.action.url}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-700 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2"
                                aria-label={airdrop.action.text || 'View details'}
                            >
                                <span>{airdrop.action.text || 'Details'}</span>
